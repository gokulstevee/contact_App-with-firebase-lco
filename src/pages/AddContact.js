...
const AddContact = () => {
  ...
  useEffect(() => {
    if (contactToUpdate) {
      ...
      setUpdate(contactToUpdate.update);
  ...
  const addContact = async () => {
    ...
    try {
      ...
      console.log("something wrong in addcontact" + error);
    }
  };
    ...
    try {
      firebase
        ...
        .set({
          ...
          phoneNumber,
          address,
          picture: downloadUrl === undefined ? null : downloadUrl,
          star,
          update:true,
          date,
        });
      ...
      console.log("something wrong in updatecontact" + error);
      toast("something wrong in updatecontact", { type: "error" });
    }
  };
